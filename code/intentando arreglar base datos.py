...
tr.append(pd.read_csv(r"C:\Users\Mike\OneDrive\Documentos\TFG\Documentación teórica\TONAS_0 para trastear\TONAS\Deblas\11-D_TPabon.csv", names=["inicio", "duración", "tono", "nidea"]).drop([0], axis=0))
